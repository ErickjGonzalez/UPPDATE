...
<head>
  ...
  <title>Registrar Carrera - Super Admin UPPDATE</title>
  ...
  <main class="main-container">
    ...
    <section class="page-hero">
      <div class="hero-content">
        <h1 class="page-title">Registrar Nueva Carrera</h1>
        <p class="page-subtitle">Crea una nueva carrera académica y asígnala a un director. Completa toda la información requerida para el registro.</p>
      </div>
    </section>
    ...
    <div class="info-box">
      ...
      <p class="info-text">
        ...
        Una vez registrada la carrera, podrás asignar materias, docentes y estudiantes desde el panel de administración.
      </p>
    </div>

    <!-- Formulario -->
    <div class="form-container">
      <form method="POST" action="{{ route('superadmin.carreras.store') }}" id="carreraForm">
        @csrf
        ...
        <div class="form-grid">
          ...
          <div class="form-group full-width">
            ...
            <div class="char-counter-container">
              <div class="char-counter" id="nombre-counter">
                <span id="nombre-current">{{ mb_strlen(old('nombre', '')) }}</span>/60
              </div>
          ...
          <div class="form-group full-width">
            ...
            <textarea name="descripcion" rows="4" 
                      ...
                      placeholder="Describe los objetivos, enfoque y características principales de la carrera">{{ old('descripcion') }}</textarea>
            <div class="char-counter-container">
              <div class="char-counter" id="descripcion-counter">
                <span id="descripcion-current">{{ mb_strlen(old('descripcion', '')) }}</span>/500
              </div>
          ...
          <div class="form-group">
            ...
            <div class="input-with-icon">
              <input type="url" name="plan_estudios_url" value="{{ old('plan_estudios_url') }}" 
                     class="form-input" placeholder="https://ejemplo.com/plan-estudios.pdf" maxlength="250"
            ...
            <div class="char-counter-container">
              <div class="char-counter" id="plan_estudios_url-counter">
                <span id="plan_estudios_url-current">{{ mb_strlen(old('plan_estudios_url', '')) }}</span>/250
              </div>
          ...
          <div class="form-group">
            ...
            <div class="char-counter-container">
              <div class="char-counter" id="coordinador-counter">
                <span id="coordinador-current">{{ mb_strlen(old('coordinador', '')) }}</span>/50
              </div>
              <div class="char-limits">Mín. 2 - Máx. 50 caracteres</div>
            </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="duracion" value="{{ old('duracion') }}" 
                   class="form-input" placeholder="Ej: 4 años, 8 semestres" maxlength="50"
                   data-validation="maxLength,noEmojis" data-max-length="50">
            <div class="char-counter-container">
              <div class="char-counter" id="duracion-counter">
                <span id="duracion-current">{{ mb_strlen(old('duracion', '')) }}</span>/50
              </div>
          ...
          <div class="form-group">
            ...
            <div class="char-counter-container">
              <div class="char-counter" id="modalidad-counter">
                <span id="modalidad-current">{{ mb_strlen(old('modalidad', '')) }}</span>/50
              </div>
              <div class="char-limits">Máx. 50 caracteres</div>
            </div>
          ...
          <div class="form-actions">
            <button type="submit" class="btn-submit" id="submitBtn" disabled>
              ...
              <span id="submitText">Registrar Carrera</span>
            </button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updateGlobalCounters() {
        ...
        if (submitBtn.disabled) {
          ...
          submitText.textContent = 'Registrar Carrera';
      ...
      form.addEventListener('submit', function(event) {
        ...
        if (errorCount > 0) {
          ...
          showTempNotification('Registrando carrera... Por favor, espere.', 'info');
