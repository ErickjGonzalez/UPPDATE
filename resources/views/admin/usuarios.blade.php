...
<head>
  ...
  <title>Registrar Usuario - Super Admin UPPDATE</title>
  ...
  <style>
    ...
    * {
    ...
    /* Header y navegación - ESTILO MEJORADO */
    .main-header {
    ...
    .valid {
      ...
      background-image: url("data:image/svg+xml,%3Csvg xmlns='http://www.w3.org2000/svg' fill='%2310b981' viewBox='0 0 24 24'%3E%3Cpath d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z'/%3E%3C/svg%3E");
      background-repeat: no-repeat;
      background-position: right 1rem center;
      background-size: 1.5em;
      padding-right: 3rem;
    ...
    .strength-bar.very-weak { background: #ef4444; }
    .strength-bar.weak { background: #f97316; }
    .strength-bar.moderate { background: #f59e0b; }
  ...
  <main class="main-container">
    ...
    <section class="page-hero">
      <div class="hero-content">
        ...
        <p class="page-subtitle">Agrega nuevos directores o rectores al sistema. Completa toda la información requerida para el registro.</p>
      </div>
    </section>
    ...
    <!-- Mensajes de error del servidor -->
    @if($errors->any())
      <div class="validation-message validation-error" style="margin-bottom: 2rem;">
    ...
    <div class="validation-summary">
      ...
      <div class="validation-stats">
        ...
        <div class="validation-stat">
          <div class="stat-value" id="totalFields">8</div>
    ...
    <div class="info-box">
      ...
      <p class="info-text">
        Todos los campos marcados con asterisco (*) son obligatorios. Asegúrate de que la información sea precisa y completa. 
    ...
    <div class="form-container">
      <form method="POST" action="{{ route('superadmin.usuarios.store') }}" id="userForm">
        @csrf
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" value="{{ old('name') }}" 
                   class="form-input" required maxlength="100" minlength="2"
            ...
            <div class="char-counter-container">
              <div class="char-counter" id="name-counter">
                <span id="name-current">{{ mb_strlen(old('name', '')) }}</span>/100
              </div>
              <div class="char-limits">Mín. 2 - Máx. 100 caracteres</div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="char-counter-container">
              <div class="char-counter" id="email-counter">
                <span id="email-current">{{ mb_strlen(old('email', '')) }}</span>/100
              </div>
          ...
          <div class="form-group">
            ...
            <div class="input-with-icon">
              <input type="text" name="telefono" value="{{ old('telefono') }}" 
                     ...
                     data-validation="phone,maxLength,noEmojis"
                     data-max-length="20"
            ...
            <div class="char-counter-container">
              <div class="char-counter" id="telefono-counter">
                <span id="telefono-current">{{ mb_strlen(old('telefono', '')) }}</span>/20
              </div>
              <div class="char-limits">Máx. 20 caracteres</div>
            </div>
            <div class="validation-message validation-info" id="telefono-validation">
              <i class="fas fa-info-circle"></i>
              <span>Formato: números, espacios, paréntesis y guiones.</span>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="input-with-icon">
              <input type="password" name="password" id="password" 
                     ...
                     data-validation="required,minLength,passwordStrength"
                     data-min-length="8"
            ...
            <div class="char-counter-container">
              <div class="char-counter" id="password-counter">
                <span id="password-current">0</span>/∞
              </div>
              <div class="char-limits">Mín. 8 caracteres</div>
            </div>
            <div class="validation-message validation-info" id="password-validation">
              <i class="fas fa-info-circle"></i>
              <span>Mínimo 8 caracteres con mayúsculas, minúsculas, números y símbolos.</span>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="input-with-icon">
              <input type="password" name="password_confirmation" id="confirmPassword" 
                     ...
                     data-validation="required,passwordMatch"
                     placeholder="Repite la contraseña">
              <i class="fas fa-eye input-icon" id="toggleConfirmPassword"></i>
            </div>
            <div class="char-counter-container">
              <div class="char-counter" id="confirmPassword-counter">
                <span id="confirmPassword-current">0</span>/∞
              </div>
              <div class="char-limits">Debe coincidir con la contraseña</div>
            </div>
            <div class="validation-message validation-info" id="confirmPassword-validation">
              <i class="fas fa-info-circle"></i>
              <span>Las contraseñas deben coincidir exactamente.</span>
            </div>
          </div>
          ...
          <div class="form-group full-width">
            ...
            <select name="role" class="form-select" required
              ...
              <option value="rector" {{ old('role') == 'rector' ? 'selected' : '' }}>Rector</option>
              <option value="comunicacion" {{ old('role') == 'comunicacion' ? 'selected' : '' }}>Comunicación</option>
            </select>
            <div class="validation-message validation-info" id="role-validation">
              <i class="fas fa-info-circle"></i>
              <span>Selecciona un rol de la lista. Campo obligatorio.</span>
            </div>
          </div>
          ...
          <div class="form-actions">
            <button type="submit" class="btn-submit" id="submitBtn" disabled>
              ...
              <span id="submitText">Registrar Usuario</span>
            </button>
            <a href="{{ route('admin.inicio') }}" class="btn-secondary">
  ...
  <footer class="main-footer">
    <div class="footer-content">
      <div class="footer-links">
        ...
        <a href="{{ route('superadmin.carreras.create') }}" class="footer-link">Carreras</a>
        <a href="{{ route('admin.listausuario') }}" class="footer-link">Usuarios</a>
        <a href="#" class="footer-link">Reportes</a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updatePasswordStrength(password) {
        ...
        bars.forEach((bar, index) => {
          ...
          if (index < strength) {
            ...
            else if (strength === 3) bar.classList.add('moderate');
            else if (strength === 4) bar.classList.add('strong');
            else if (strength === 5) bar.classList.add('very-strong');
          }
        });
      }
      ...
      function updateGlobalCounters() {
        ...
        if (submitBtn.disabled) {
          ...
          submitBtn.innerHTML = '<i class="fas fa-user-plus"></i> ' + submitText.textContent;
